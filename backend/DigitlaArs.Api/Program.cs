...
{
    var dbContext = scope.ServiceProvider.GetRequiredService<DigitalArsDbContext>();
    var canConnect = await dbContext.Database.CanConnectAsync();

    if (!canConnect)
    {
        throw new InvalidOperationException("No fue posible establecer conexión con la base de datos SQL Server.");
    }
}
